...
<img src="./Images/2l5k_rnacomposer.png" width="33%" height="33%" title="RNAComposer 3D model" style="display: block; margin: 0 auto"  >
...
For example, `2L5K_model.top` and `2L5K_model.crd` are the topology (parameter) and initial coordinate files of the solvated aptamer ready to be used in the subsequent GaMD simulation.
...
<img src="./Images/struct_md.png" width="33%" height="33%" style="display: block; margin: 0 auto">
...
<img src="./Images/G_MMPBSA.png" width="33%" height="33%" style="display: block; margin: 0 auto">
</div>
--- 
