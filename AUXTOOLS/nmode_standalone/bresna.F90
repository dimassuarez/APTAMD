...
! Di+ increasing maxres for water-belly 
   parameter (maxres=25000)
   ...
   do 300 ii = 1,nres
      ...
      do 280 jj = ii,nres
         ...
         frozj = igres(jj) <= 0
!
! Di+ the following line has been changed to make sure that the energy
! of the PROT-WAT (PROT=BELLY) systems is identical in NMODE and in SANDER 
!        if(frozi .or. frozj) skip(jj) = .true.    ===> THE LOGICAL OPERATOR WAS
!        NOT CONSISTENT
